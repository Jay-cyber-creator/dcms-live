...
<body>
    ...
    <div class="container container-fluid" style="min-height: 100vh">
        <div class="d-flex justify-content-center align-items-center vh-100 text-center ">
            <div class="border border-1 rounded shadow form-container h-auto pb-5" style="width: 50%;">
                <form method="Post" class="p-4" style="width: 100%; height: 100%">
                    <div class="mb-3">
                        <h1 class="form-title fs-4">Login Form</h1>
                    </div>
                    <div>
                    ...
                    <button type="submit" name="login-button"
                        class="  mt-4 rounded py-2 px-4 fs-6 fs-md-5 btn-custom">Login</button>
                </form>
                ...
                <div class="d-flex justify-content-center align-content-center mt-4 p-0 ">
                    <button type="button"
                        class="d-flex justify-content-between align-items-center p-2 rounded google-btn"
                        style="width: 50%; ">
